          ...
          <div className='wrapSearch'>
            <div className='wrapQueryGames'>
              ...
              <div className='boxContentGames'>
                ...
                <div className='noCrack' onClick={() => {setIsCrack(true); setCurrentPage(1);}} style={isCrack === true ? {backgroundColor: 'rgba(255, 255, 255, 0.19)', color: 'white', border: 'solid 1px white'} : {color: 'rgba(255, 255, 255, 0.556)', border: 'solid 1px rgba(255, 255, 255, 0.556)'}}>Crack</div> {/* {color: 'transparent', border: 'none'} */}
